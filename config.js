//mongodb config:
//host => localhost (same server as node.js)
//default port is 27017
//use the db with name fse
exports.db = {
	"host":"mongodb://localhost/fse",
	"port":"27017",
	"database":"fse",
	"auth": {
		'user': 'fse_server',
...
exports.sess_secret = 'VfdQAKct5X_Hj6PXJm7Nc6vTSQgVW3Pb';

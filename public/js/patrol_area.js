...
$(document).ready(function(){
    ...
    if(patrolAreaData != null) {
        console.log(patrolAreaData);
        console.log("after");


        var pdata = JSON.parse(patrolAreaData.toString().replace(/&quot;/g,'"'));
        console.log(pdata);
        jQuery.each(pdata, function (i, val) {
            if(val.name == "" || val.name == null) return true;
...
$(document).ready(function(){
	...
	$("#pageTitle").html("<a class='navbar-brand navbar-brand-primary' href='/'><span class='fa fa-users' /> Patrol Area</a>");
});